...
const INTRO_MESSAGE =
  "Welcome to SightTech! SightTech is an AI-powered application designed to assist visually impaired users. You can say commands like 'Open Object Detection', 'Go to News', or 'Start Currency Detection' to navigate. Say something now to begin!";
